(function() {
    var h = {}
        ...
        dm: ["douyu.tv", "douyutv.com", "175kh.com", "mm111.net", "s4.175kh.com", "acfun.tv", "2144.com", "acfun.com", "douyu.com"],
    ...
    ;
    mt.i.Ha = function(a) {
        return (a = mt.i.P(a, t)) && a.length ? String(a[0]) : ""
    }
    ;
    mt.i.rb = function(a) {
        return mt.i.P(a, v)
    ...
    mt.localStorage.set = function(a, b, d) {
        ...
        try {
            window.localStorage ? (b = g.getTime() + "|" + b,
                window.localStorage.setItem(a, b)) : mt.localStorage.K() && (mt.localStorage.h.expires = g.toUTCString(),
                mt.localStorage.h.load(document.location.hostname),
                mt.localStorage.h.setAttribute(a, b),
        ...
        if (window.localStorage) {
            ...
            try {
                return mt.localStorage.h.load(document.location.hostname),
                    mt.localStorage.h.getAttribute(a)
            } catch (g) {}
        return u
    }
    ;
    mt.localStorage.remove = function(a) {
        if (window.localStorage)
            ...
            try {
                mt.localStorage.h.load(document.location.hostname),
                    mt.localStorage.h.removeAttribute(a),
                    mt.localStorage.h.save(document.location.hostname)
            } catch (b) {}
    }
    ;
    ...
    (function() {
        var a = mt.i
            ...
            , n = {
            ga: function() {
                c.ctrk && (d.c(document, "mouseup", n.oa()),
            ...
            oa: function() {
                return function(a) {
                    a = n.Aa(a);
                    if ("" !== a) {
                        var d = (f.H + "//" + f.T + "?" + h.b.da().replace(/ep=[^&]*/, "ep=" + encodeURIComponent(a))).length;
                        d + (f.z + "").length > f.X || (d + encodeURIComponent(l.join("!") + (l.length ? "!" : "")).length + (f.z + "").length > f.X && n.I(),
                            l.push(a),
                        (l.length >= f.ra || /\*a\*/.test(a)) && n.I())
                    }
                }
            },
            Aa: function(k) {
                ...
                var q;
                g.aa ? (q = Math.max(document.documentElement.scrollTop, document.body.scrollTop),
                ...
                e.push(k.pb);
                e.push(k.Ka);
                (d = "a" === (d.tagName || "").toLowerCase() ? d : a.za(d)) ? (e.push("a"),
                    e.push(b.g(encodeURIComponent(d.href)))) : e.push("b");
                return e.join("*")
            },
            Ea: function(k, d, m, q) {
                k = a.Ha(d);
    ...
    (function() {
        ...
        var f = mt.event, p = h.B, l = t, n = t, e = t, k = t, w = +new Date, m = w, q = 0, x = t, r = d("visibilityState"), y = d("hidden"), z;
        b();
        (function() {
    ...
    (function() {
        ...
        var d = mt.lang
            ...
            wa: function() {
                if (0 < e.w.length)
                    for (var a = 0, d = e.w.length; a < d; a++)
                        e.S(e.w[a]);
                e.w = u
            },
            S: function(a) {
            ...
            _trackEvent: function(a) {
                2 < a.length && (e.e |= 8,
                    ...
                    h.b.a.st = 4,
                    h.b.a.et = 4,
                    h.b.a.ep = d.g(a[1]) + "*" + d.g(a[2]) + (a[3] ? "*" + d.g(a[3]) : "") + (a[4] ? "*" + d.g(a[4]) : ""),
                    h.b.j())
            },
            _setCustomVar: function(a) {
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < m && 4 > m) {
                        ...
                        "" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.$a("Hm_cv_" + c.id)
                    }
                }
            },
            ...
            _trackRTEvent: function(a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m)
                        ...
                        for (var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * p.z).toString(16) + "|" + m + "|", l = [], r = 0; r < m; r++)
                            l.push(r),
        ...
        a.prototype = {
            ...
            Y: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.ca(document.location.href, d))
                        return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },
            Ia: function() {
                ...
                var a = v;
                this.F(document.referrer) && this.F(document.location.href) ? a = t : (a = b.Z(document.referrer),
            ...
            j: function(a) {
                var b = this;
                b.a.rnd = Math.round(Math.random() * k.z);
                w.A("stag-b");
                var e = k.H + "//" + k.T + "?" + b.da();
                w.A("stag-d");
                b.ka(e);
            ...
            na: function() {
                ...
                a && (d.test(a) && e && l) && (this.a.rnd = Math.round(Math.random() * k.z),
                        ...
                        for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, g, k = 0, n = b.length; k < n; k++)
                            d = b[k],
                                l !== s ? (f = d.getAttribute("onclick"),
                                    ...
                                    (l.test(f) || l.test(g) || m.test(d)) && a.push(b[k])) : (l.test(f) || l.test(g)) && a.push(b[k])) : m !== s && (d = d.getAttribute("id"),
                                m.test(d) && a.push(b[k]));
                        return a
                    }
                }
            ...
            var f = {
                ha: function() {
                    for (var b = c.cvcf.length, g, n = 0; n < b; n++)
                        (g = a.ya(decodeURIComponent(c.cvcf[n]))) && d.c(g, "click", f.ua())
                },
                ua: function() {
                    return function() {
                        h.b.a.et = 86;
