...
public class JavaProxyTest {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(newJavaProxyInterface.getClass());
        byte[] $Proxy0s = ProxyGenerator.generateProxyClass("$Proxy0", new Class[]{ConcreteClass.class});
        FileOutputStream fileOutputStream = new FileOutputStream("/Users/wangcai/Desktop/$Proxy0.class");
...
class ConcreteClass1 implements JavaProxyInterface {
    @Override
    public void gotoSchool() {
        System.out.println("gotoSchool1111111");
    }

    @Override
    public void gotoWork() {
        System.out.println("gotoWork111111");
    }
